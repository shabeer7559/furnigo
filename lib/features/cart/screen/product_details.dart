...
class ProductDetails extends ConsumerStatefulWidget {
  ...
  final catId;
  final proId;
  const ProductDetails(this.image, this.name, this.price, this.review,
      this.qnty, this.catId, this.proId,
      {super.key});
          ...
          children: [
            InkWell(
              onTap: () {
                ...
                if (tap = true) {
                  ref.watch(homeScreenPro).favoriteAdd(currentUserModel!.id,
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      color: ColorConst.secondaryColor,
                      image:
                          DecorationImage(image: AssetImage(ImageConst.frame)),
