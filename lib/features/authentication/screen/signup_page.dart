...
import '../../constants/searchConantry.dart';
...
class _SignUpState extends ConsumerState<SignUp> {
  ...
  data() {
    ref.watch(addingControllerProvider).addingRepo(UserModel(
  ...
  uploadFile() async {
    ...
    var uploadTask = await FirebaseStorage.instance
        ...
        .putFile(files, SettableMetadata(contentType: 'image/jpge'));
  ...
  Future<void> emailChecking() async {
    try {
      ...
      ScaffoldMessenger.of(context)
          .showSnackBar(SnackBar(content: Text("The Email Already Exist")));
    }
  }
  ...
  Widget build(BuildContext context) {
    return InternetChecker(
      placeHolder: Lottie.asset(ImageConst.internetcheck, width: w * 0.7),
                              ...
                              if (imgurl != "" &&
                                ...
                                imgurl == ""
                                    ? ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                                        content: Text("Please choos a photo")))
                                    : nameController.text == ""
                                        ? ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                                            content:
                                                Text("Pleas Enter your Name")))
                                        : emailController.text == ""
                                            ? ScaffoldMessenger.of(context)
                                            ...
                                            : passwordController.text == ""
                                                ...
                                                : confirmPasswordController.text ==
                                                        ""
                                                    ? ScaffoldMessenger.of(context)
                                                        .showSnackBar(SnackBar(content: Text("pleas confirm your password")))
