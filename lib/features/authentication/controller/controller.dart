...
class addingController{
  ...
  addingRepo(name,email,password,image,favorite,cartItems,reviews,address,payment){_repocitry.adding(name: name, email: email, password: password, image: image, favorite: favorite, cartItems: cartItems, reviews: reviews, address: address, payment: payment);}
}